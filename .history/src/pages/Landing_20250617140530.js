    ...
    return (
        <div className="min-h-screen relative">
            ...
            <div 
                ...
                style={{
                    backgroundImage: 'url("/public/bg-pic.jpg")',
            ...
            <div className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl w-full space-y-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4 mt-12">
                        ...
                        <Link
                            to="/signin"
                            className="px-8 py-3 text-lg font-medium text-white bg-transparent border-2 border-white rounded-lg hover:bg-white hover:bg-opacity-10 transition-colors duration-200 transform hover:scale-105"
                        >
                            Sign In
                        </Link>
                    </div>
