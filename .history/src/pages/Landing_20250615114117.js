...
function Landing() {
  ...
  return (
    ...
    >
      <div className="bg-green/20 backdrop-blur-2xl p-10 rounded-3xl shadow-2xl border border-white/20 max-w-xl text-center text-white animate-fade-in bg-blue">
        <div className="mb-6">
          <img
