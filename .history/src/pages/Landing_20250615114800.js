...
function Landing() {
  ...
  return (
    ...
    >
      <div className="bg-gray/20 backdrop-blur-3xl p-10 rounded-3xl shadow-2xl border border-blue-500 border-white/20 p-4 rounded-md text-center text-black animate-fade-in bg-blue">
        <div className="mb-6">
          <img
