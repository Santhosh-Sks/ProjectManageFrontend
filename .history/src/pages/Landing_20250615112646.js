...
function Landing() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url('https://plus.unsplash.com/premium_photo-1706259481452-f857c96ceaca?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')` }} // Place your background image in public/bg-tech.jpg
    >
      <div className="bg-white/10 backdrop-blur-md p-10 rounded-3xl shadow-2xl border border-white/20 max-w-xl text-center text-white animate-fade-in">
        <div className="mb-6">
          <img
