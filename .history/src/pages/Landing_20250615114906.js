...
function Landing() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url('/bg-pic.jpg')` }} 
    >
      <div className="bg-gray/20 backdrop-blur-3xl p-10 rounded-3xl shadow-2xl border border-blue-800 border-white/20 max-w-xl text-center text-black animate-fade-in bg-blue">
        <div className="mb-6">
          <img
        ...
        <p className="text-lg text-bold md:text-xl font-medium mb-8 animate-fade-in ">
