...
const Dashboard = () => {
    ...
    console.log('Filtered projects:', filteredProjects.filter(project => project.createdBy === user?.email));
        ...
        <div className="dashboard-container">
            ...
            <div className="recent-projects">
                ...
                <div className="projects-grid">
                    {filteredProjects
                        .filter(project =>
                            project.createdBy?.toLowerCase().trim() === user?.email?.toLowerCase().trim()
                        )
